                ...
                <div class="row mt-4">
                  <div class="col-md-6">
                    ...
                    <CInputGroup class="mb-4">
                      ...
                      <CFormInput v-model="formData.phone" placeholder="Telefono" type="text" tabindex="7" />
                    </CInputGroup>
                    <CInputGroup class="mb-4">
                      <CInputGroupText>
                  ...
                  <div class="col-md-6">
                    <CInputGroup class="mb-3">
                      ...
                      <CFormInput v-model="formData.document" placeholder="Documento" type="text" tabindex="2" />
                    </CInputGroup>
                    <CInputGroup class="mb-3">
                      <CInputGroupText>
                        <CIcon icon="cil-contact" />
                    ...
                    <CInputGroup class="mb-4">
                      ...
                      <CFormInput v-model="formData.password_confirmed" type="password" placeholder="Confirmar contraseña" tabindex="10" />
                    </CInputGroup>
                  </div>
                </div>
                <div class="d-grid">

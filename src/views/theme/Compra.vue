<template>
  ...
  <CTable striped>
    ...
    <CTableBody>
      <CTableRow v-for="(row, index) in tableData" :key="index">
        ...
        <CTableDataCell>{{ row.supplier }}</CTableDataCell>
  ...
  <CModal alignment="center" size="lg" scrollable :visible="visibleVerticallyCenteredScrollableDemo"
    ...
    <CModalHeader>
      <CModalTitle id="VerticallyCenteredExample2">Crear Detalle de la Compra</CModalTitle>
    </CModalHeader>
    <CModalBody>
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="form">
              ...
              <div id="inventario-company_id" class="field-wrapper input mt-2">
                ...
                <select class="form-control" v-model="formData.supplier_id">
                  ...
                  <option v-for="supplier in supplierList" :value="supplier.id" :key="supplier.id">{{ supplier.name }}
                  </option>
                </select>
                <template v-if="errors.supplier_id.length > 0">
                  <b :key="e" v-for="e in errors.supplier_id" class="text-danger">{{ e }}</b>
                </template>
              </div>
            </div>
          </form>
  ...
  <CModal alignment="center" size="lg" scrollable :visible="visibleEdit" @close="closeModalAndResetFormData"
    ...
    <CModalHeader>
      <CModalTitle id="VerticallyCenteredExample2">Editar Detalle de la Compra</CModalTitle>
    </CModalHeader>
    <CModalBody>
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="form">
              ...
              <div id="inventario-company_id" class="field-wrapper input mt-2">
                ...
                <select class="form-control" v-model="formData.customer_id">
                  <option value="" selected disabled>Seleccione un cliente</option>
                  <option v-for="customer in supplierList" :value="customer.id" :key="customer.id">
                    {{ customer.name }}
                  </option>
                </select>
      ...
      <!-- MODAL DETALLE DE COMPRA EDITAR-->
      <div class="container mt-5">
...
export default {
  ...
  setup() {
    ...
    const TableDataApi = async () => {
      try {
        const { data } = await useApi('shopping');
